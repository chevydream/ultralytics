...
if __name__ == "__main__":
    MODEL_PATH = f"E:/DLModel/models"
    IR_MODEL_NAME = "yolov8n"

    core = Core()

    #定义量化后的模型的路径名称
    pt_path = f"{MODEL_PATH}/yolov8n.pt"
    ...
    seg_validator = DetectionValidator(args=args)
    seg_validator.data = check_det_dataset('ultralytics/cfg/datasets/coco.yaml')
    seg_data_loader = seg_validator.get_dataloader("E:/DLDataSets/COCO", 1)
